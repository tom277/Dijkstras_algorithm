...
class SetUI
{
	...
	public:
		...
		//print functions
		void print(StringRelation *s);
		void print(string s, COLOR color);
		void print(SetOfStrings *s, string message);

		void Clear();

		//check
		void reflexive(StringRelation *s);
		void symmetric(StringRelation *s);
		void transtivie(StringRelation *s);
		void equivalence_relation(StringRelation *s);

		//print & find the eqcrelation
		void equivalence_relation(StringRelation *s, string element);

		void isReachable(StringRelation *s, string first, string second);
		void Path(StringRelation *s, string first, string second);
};
